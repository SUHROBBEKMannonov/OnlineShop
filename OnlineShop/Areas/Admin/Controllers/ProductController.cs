...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TagId"] = new SelectList(_db.TagNames.ToList(), "Id", "Name");
        ...
        public IActionResult Edit(int? Id)
        {
            ...
            var product = _db.Products.Include(c=>c.SpecialTag).Include(c=>c.ProductTypes).FirstOrDefault(x => x.Id == Id);
            if (product == null)
            {
                return NotFound();
            }
